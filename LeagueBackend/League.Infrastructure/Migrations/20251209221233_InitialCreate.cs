    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 12, 9, 22, 12, 33, 590, DateTimeKind.Utc).AddTicks(1584), "Full Access", "Admin", null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2025, 12, 9, 22, 12, 33, 590, DateTimeKind.Utc).AddTicks(1602), "Team Management", "Delegate", null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2025, 12, 9, 22, 12, 33, 590, DateTimeKind.Utc).AddTicks(1606), "Match Reporting", "Referee", null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 12, 9, 22, 12, 33, 590, DateTimeKind.Utc).AddTicks(1616), "Read Only", "Fan", null }
                });
